...
1. Add this repository as a [git submodule](https://git-scm.com/book/en/v2/Git-Tools-Submodules).
   ...
   git submodule add https://github.com/cosmopetrich/ue-thirdparty-release-action Source/barlib
   ```
...
1. Update the submodule.
   ...
   ```bash
   git -C Source/barlib pull
   git commit -m "Update barlib" Source/barlib .gitmodules
   ```
